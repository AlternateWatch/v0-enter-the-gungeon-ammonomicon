  ...
  return (
    <>
      ...
      <div className="space-y-6 py-4">
        ...
        {gun.synergies && <div><h4 className="font-semibold mb-2">Sinergias</h4><div className="text-base whitespace-pre-wrap"><WikiLinkRenderer text={gun.synergies} /></div></div>}
        {gun.notes && <div><h4 className="font-semibold mb-2">Notas</h4><div className="text-base whitespace-pre-wrap"><WikiLinkRenderer text={gun.notes} /></div></div>}
      </div>
    </>
  );
};
